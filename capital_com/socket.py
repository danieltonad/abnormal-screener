            ...
            while self.running and self.websocket:
                try:
                    ...
                    if data["destination"] == "OHLCMarketData.subscribe":
                        ...
                        # print(f"Data: {payload['epic']} O: {payload['o']} H: {payload['h']} L: {payload['l']} C: {payload['c']}   - [{len(memory.ohlc_history):,}]", end="\r")
